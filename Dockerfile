...
COPY ./configs/fail2ban-filter.d-sshd-invaliduser.conf /etc/fail2ban/filter.d/sshd-invaliduser.conf
...
RUN install-php-extensions bcmath gd intl exif redis imagick excimer
